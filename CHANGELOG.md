...
- One-click install for VS Code and Cursor
- Support for 11 MCP clients: Claude Desktop, Claude Code, Cursor, Windsurf, VS Code/Copilot, Zed, Continue.dev, Cline, Roo Code, Codex, MCP Inspector
